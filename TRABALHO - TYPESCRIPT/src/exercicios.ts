 ...
 */
function perguntar(mensagem: string): Promise<string> {
...
class Exercicios {
   ...
   */
  static async ex01(): Promise<void> {
    console.log("\n=== EXERCÍCIO 01 — Soma de dois números ===\n");

    // Classe responsável por guardar os números e calcular a soma
    class SomaNumeros {
      numero1: number; // Primeiro número digitado
      numero2: number; // Segundo número digitado
   ...
   */
  static async ex02(): Promise<void> {
    console.log("\n=== EXERCÍCIO 02 — Par ou Ímpar ===\n");
   ...
   */
  static async ex03(): Promise<void> {
    console.log("\n=== EXERCÍCIO 03 — Média de três notas ===\n");
   ...
   * Fórmula: F = (C × 9/5) + 32
   */
  static async ex04(): Promise<void> {
    console.log("\n=== EXERCÍCIO 04 — Celsius para Fahrenheit ===\n");
   ...
   */
  static async ex05(): Promise<void> {
    console.log("\n=== EXERCÍCIO 05 — Números pares de 1 a 20 ===\n");
   ...
   */
  static async ex06(): Promise<void> {
   ...
   */
  static async ex07(): Promise<void> {
   ...
   */
  static async ex08(): Promise<void> {
    ...
    const vogais: string = "aeiouAEIOUáéíóúÁÉÍÓÚâêîôûÂÊÎÔÛãõÃÕàèìòùÀÈÌÒÙ";
   ...
   */
  static async ex09(): Promise<void> {
    console.log("\n=== EXERCÍCIO 09 — Calculadora simples ===\n");
   ...
   */
  static async ex10(): Promise<void> {
    console.log("\n=== EXERCÍCIO 10 — Ordenar array em ordem crescente ===\n");
   ...
   */
  static async ex11(): Promise<void> {
    console.log("\n=== EXERCÍCIO 11 — Classe Pessoa ===\n");

    // Definição da classe Pessoa
    class Pessoa {
      nome: string;   // Atributo nome
      idade: number;  // Atributo idade
   ...
   */
  static async ex12(): Promise<void> {
    console.log("\n=== EXERCÍCIO 12 — Classe Aluno (herança de Pessoa) ===\n");
   ...
   */
  static async ex13(): Promise<void> {
    console.log("\n=== EXERCÍCIO 13 — Interface Veículo / Classe Carro ===\n");

    // Interface: define o contrato que qualquer veículo deve seguir
    interface Veiculo {
      acelerar(): void;
      frear(): void;
    }
    ...
    class Carro implements Veiculo {
      private modelo: string;          // private = só acessível dentro da classe
      ...
      public frear(): void {
        ...
        if (this.velocidadeAtual < 0) this.velocidadeAtual = 0; // Não pode ser negativo
   ...
   */
  static async ex14(): Promise<void> {
    console.log("\n=== EXERCÍCIO 14 — Tabuada ===\n");
   ...
   */
  static async ex15(): Promise<void> {
    console.log("\n=== EXERCÍCIO 15 — Calculadora de IMC ===\n");
   ...
   */
  static async ex16(): Promise<void> {
    console.log("\n=== EXERCÍCIO 16 — Validar senha ===\n");
   ...
   */
  static async ex17(): Promise<void> {
    console.log("\n=== EXERCÍCIO 17 — Jogo de Adivinhação ===\n");
   ...
   */
  static async ex18(): Promise<void> {
...
async function main(): Promise<void> {
  ...
  const opcoes: Record<number, () => Promise<void>> = {
    1:  Exercicios.ex01,
    2:  Exercicios.ex02,
    3:  Exercicios.ex03,
    4:  Exercicios.ex04,
